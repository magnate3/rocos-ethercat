...
#define NOTIFICATION_MEMBER_COUNT       4
...
static EC_INLINESTART EC_T_CHAR* EC_STRSTR(EC_T_CHAR* szStr, const EC_T_CHAR* szSubStr)
{
    EC_T_INT i;
...
#define MAX_FILE_NAME_SIZE  64  /* maximum length of file name for FoE Download/Upload */
...
#define EC_NUM_ERROR_NOTIFICATIONS                                 42       /* number of error notifications in 0x00010000 ... 0x0001fff */
...
/* frame response error notification bit masks */
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_UNDEFINED           (1 << eRspErr_UNDEFINED)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_NO_RESPONSE         (1 << eRspErr_NO_RESPONSE)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_WRONG_IDX           (1 << eRspErr_WRONG_IDX)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_UNEXPECTED          (1 << eRspErr_UNEXPECTED)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_FRAME_RETRY         (1 << eRspErr_FRAME_RETRY)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_RETRY_FAIL          (1 << eRspErr_RETRY_FAIL)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_FOREIGN_SRC_MAC     (1 << eRspErr_FOREIGN_SRC_MAC)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_NON_ECAT_FRAME      (1 << eRspErr_NON_ECAT_FRAME)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_ALL                 (0xFFFFFFFF)
#define EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_DEFAULT             (EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_ALL & ~EC_FRAME_RESPONSE_ERROR_NOTIFY_MASK_NON_ECAT_FRAME)
...
typedef enum _EC_T_FRAME_RSPERR_TYPE
{
    ...
    eRspErr_FOREIGN_SRC_MAC = 6,        /*< Frame with MAC from other Master received. Used for collision detection. */
...
{
    EC_T_DWORD  dwTferId;                                   /* Tfer ID passed to the API */
    EC_T_DWORD  dwResult;                                   /* Result */
    EC_T_BOOL   bRead;
...
{
    EC_T_DWORD                  dwTferId;                   /* Tfer ID passed to the API */
    EC_T_EEPROM_OPERATION_TYPE  eType;                      /* EEPRom operation type */
    ...
    union 
    {
        struct
        {
            EC_T_WORD           wEEPRomStartOffset;         /* Start address of EEPRom read operation. Given by emReadSlaveEEPromReq */
            EC_T_WORD*          pwData;                     /* Pointer to WORD array contains the read data. Given by emReadSlaveEEPromReq */
            EC_T_DWORD          dwReadLen;                  /* Number of Words to be read. Given by emReadSlaveEEPromReq */
            EC_T_DWORD          dwNumOutData;               /* Number of Words actually read from EEPRom */
        } EC_PACKED(8) Read;
        struct
        {
            EC_T_WORD           wEEPRomStartOffset;         /* Start address of EEPRom write operation. Given by emWriteSlaveEEPromReq */
            EC_T_WORD*          pwData;                     /* Pointer to WORD array contains the data to be written. Given by emWriteSlaveEEPromReq */
            EC_T_DWORD          dwWriteLen;                 /* Number of Words to be written. Given by emWriteSlaveEEPromReq */
        } EC_PACKED(8) Write;
        struct
        {
...
typedef struct _EC_T_PORT_OPERATION_NTFY_DESC
{
    ...
    EC_T_DWORD          dwResult;                           /* Result */
    EC_T_SLAVE_PROP     SlaveProp;                          /* Slave properties */
    EC_T_WORD           wPortStateOld;                      /* State of the slave ports old see ecatGetSlavePortState() */    
    EC_T_WORD           wPortStateNew;                      /* State of the slave ports new see ecatGetSlavePortState() */
...
typedef struct _EC_T_SLAVE_IDENTIFICATION_NTFY_DESC
{
    ...
    EC_T_DWORD          dwResult;                           /* Result */
    EC_T_SLAVE_PROP     SlaveProp;                          /* Slave properties */
    EC_T_WORD           wAdo;                               /* Slave address offset used for identification */
    EC_T_WORD           wValue;                             /* Slave identification value */
...
typedef struct _EC_T_MEMPROV_DESC
{
    ...
    EC_T_PFMEMREQ   pfPDOutDataWriteRequest;        /* This function will be called by the master within the
                                                     * process data transfer cycle prior to read data. */

    EC_T_PFMEMREL   pfPDOutDataWriteRelease;        /* This function will be called after all data was read
                                                     * from output process data buffer. */
    ...
    EC_T_PFMEMREQ   pfMasterRedPDOutReadRequest;    /* This function will be called by the master within the
                                                     * process data transfer cycle prior to read data. */

    EC_T_PFMEMREL   pfMasterRedPDOutReadRelease;    /* This function will be called after all data was read 
                                                     * from output process data buffer. */

    EC_T_PFMEMREQ   pfMasterRedPDOutWriteRequest;   /* This function will be called by the master within the
                                                     * process data transfer cycle prior to read data. */

    EC_T_PFMEMREL   pfMasterRedPDOutWriteRelease;   /* This function will be called after all data was read
                                                     * from output process data buffer. */

    EC_T_PFMEMREQ   pfMasterRedPDInWriteRequest;    /* This function will be called by the master within the
                                                     * process data transfer cycle prior to write data. */

    EC_T_PFMEMREL   pfMasterRedPDInWriteRelease;    /* This function will be called after all data was written
                                                     * to input process data buffer. */

    EC_T_PFMEMREQ   pfMasterRedPDInReadRequest;     /* This function will be called by the master within the
                                                     * process data transfer cycle prior to write data. */

    EC_T_PFMEMREL   pfMasterRedPDInReadRelease;     /* This function will be called after all data was written
                                                     * to input process data buffer. */
...
typedef struct _EC_T_CFG_SLAVE_INFO
{
    ...
    EC_T_BOOL                   bDisabled;              /*< out slave disabled by API */
    EC_T_BOOL                   bDisconnected;          /*< out slave diconnected by API */
    EC_T_BOOL                   bExtended;              /*< out slave generated by ecatConfigExtend() */
...
{
    EC_T_DWORD                  dwSlaveId;              /*< out Slave ID */
    EC_T_BOOL                   bMacAddr;               /*< out MAC address buffer configured */
    EC_T_BYTE                   abyMacAddr[6];          /*< out MAC address buffer */
    EC_T_BOOL                   bIpAddr;                /*< out IP address buffer configured */
    EC_T_BYTE                   abyIpAddr[4];           /*< out IP address buffer */
    EC_T_BOOL                   bSubnetMask;            /*< out SubNetMask buffer configured */
    EC_T_BYTE                   abySubnetMask[4];       /*< out SubNetMask buffer */
    EC_T_BOOL                   bDefaultGateway;        /*< out default gateway buffer configured */
    EC_T_BYTE                   abyDefaultGateway[4];   /*< out default gateway buffer */
    EC_T_BOOL                   bDnsServer;             /*< out DNS server buffer configured */
    EC_T_BYTE                   abyDnsServer[4];        /*< out DNS server buffer */
    EC_T_BOOL                   bDnsName;               /*< out DNS name buffer */
    EC_T_CHAR                   szDnsName[32];          /*< out DNS name buffer configured */
...
typedef struct _EC_T_BUS_SLAVE_INFO
{
    ...
    EC_T_WORD                   wLineCrossedFlags;      /*< out Line crossed flags (combination of EC_LINECROSSED_) */
    EC_T_WORD                   wReserved;
...
typedef struct _EC_T_MSU_INFO
{
    ...
    EC_T_WORD       wWkcStateDiagOffsIn; /*< [out] Offset of WkcState bit in diagnosis image */
    EC_T_WORD       wWkcStateDiagOffsOut;/*< [out] Offset of WkcState bit in diagnosis image */

    EC_T_DWORD      adwReserved[16];     /*< reserved */
} EC_PACKED(8)  EC_T_MSU_INFO;
