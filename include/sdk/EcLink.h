...
#define LINK_LAYER_DRV_DESC_VERSION         (EC_T_DWORD)0x00030000      /* version 3.0 */

#define EC_LINK_PARMS_SIGNATURE_PATTERN     (EC_T_DWORD)0xBA100000      /* Mask 0xfff00000 */
#define EC_LINK_PARMS_SIGNATURE_VERSION     (EC_T_DWORD)0x00030000      /* Version 3, mask 0x000f0000 */
...
} EC_PACKED(8) EC_T_LINK_PHY_WRITE_DESC;
#include EC_PACKED_INCLUDESTOP
...
#define EC_LINK_PARMS_SIGNATURE_I8254X_VERSION (EC_T_DWORD)0x00000003
...
typedef struct _EC_T_LINK_PARMS_I8254X
{
    ...
    EC_T_DWORD      dwAutoNegTimeout;       /* Timeout for Auto Negotiation */

    EC_T_BOOL       bNotUseDmaBuffers;      /* [in]  Use buffers from DMA (EC_FALSE) or from heap for receive.
                                                     AllocSend is not supported, when EC_TRUE. */
...
#define EC_LINK_PARMS_SIGNATURE_RTL8169_VERSION (EC_T_DWORD)0x00000004
...
typedef struct _EC_T_LINK_PARMS_RTL8169
{
    ...
    EC_T_BOOL       bAckErrInIrq;              /* [in]  Acknowladge errors in interrupt handler */

    /* New parameters in version 4 */
    EC_T_DWORD      dwRxBuffers;               /* [in]  Number of receive buffers,  power of 2, max 1024 */
    EC_T_DWORD      dwTxBuffers;               /* [in]  Number of transmit buffers, power of 2, max 1024*/
...
#define EC_LINK_PARMS_SIGNATURE_FSLFEC_VERSION  (EC_T_DWORD)0x00000003
...
#define ETSEC_LINKFLAG_10baseT_Half          (1 << 6)
    ...
    EC_T_ETSEC_TYPE             eETSECType;             /* [in] ETSEC chip type */
    EC_T_BOOL                   bMaster;                /* [in]  Full control over the MAC and need to initialize MAC and the connections to the PHYs */
...
{
    eCCAT_PCI    = 0, /* CCAT is on the PCI bus */
    eCCAT_EIM    = 1, /* CCAT is connected via EIM and has a fix address */
...
typedef struct _EC_T_LINK_PARMS_CCAT
{
    ...
    /* New parameters in version 2 */
    EC_T_CCAT_TYPE  eCcatType;              /* [in]  CCAT connection type */

    EC_T_UINT64     qwCcatBase;             /* [in]  Phys address of Ccat if not pci */
    EC_T_DWORD      dwCcatSize;             /* [in]  size of Ccat if not pci */
...
#define EC_LINK_PARMS_SIGNATURE_GEM_VERSION (EC_T_DWORD)0x00000005
...
typedef struct _EC_T_LINK_PARMS_GEM
{
    ...
    */
    ...
    /* New parameters in version 3 */
    EC_T_BOOL                   bUseGmiiToRgmiiConv;    /* [in]  Use XILINX GMIITORGMII Converter (EC_TRUE) or not. */
    EC_T_DWORD                  dwConvPhyAddr;          /* [in]  PHY address used to communicate with converter. In Linux doc it named "reg" */
    /* New parameters in version 4 */
    EC_T_DWORD                  dwTxDmaDesCnt;          /* [in]  Transmit DMA descriptor buffer count (!!must be power of 2, max 256!!) */
    EC_T_DWORD                  dwRxDmaDesCnt;          /* [in]  Receive DMA descriptor buffer count (!!must be power of 2, max 256!!) */

    /* New parameters in version 5 */
    EC_T_GEM_TYPE               eGemType;               /* [in]  GEM Chip type */
} EC_T_LINK_PARMS_GEM;
...
typedef struct _EC_T_LINK_PARMS_EMAC
{
    ...
    EC_T_DWORD                  dwRxInterrupt;          /* [in]  Receive interrupt number (IRQ) */
    EC_T_DWORD                  dwRegisterLength;       /* [in]  Physical length of register block */
    EC_T_BOOL                    bNotUseDmaBuffers;      /* [in]  AllocSend is not supported, when EC_TRUE */
...
#define EC_LINK_PARMS_SIGNATURE_R6040_VERSION (EC_T_DWORD)0x00000002
...
#define EC_LINK_PARMS_SIGNATURE_DW3504_VERSION (EC_T_DWORD)0x00000003
...
typedef struct _EC_T_LINK_PARMS_DW3504
{
    ...
    */
    ...
    EC_T_DWORD                  dwTxDmaDesCnt;          /* [in]  Transmit DMA descriptor buffer count (!!must be power of 2, max 256!!) */
    EC_T_DWORD                  dwRxDmaDesCnt;          /* [in]  Receive DMA descriptor buffer count (!!must be power of 2, max 256!!) */
} EC_PACKED(8) EC_T_LINK_PARMS_DW3504;
#include EC_PACKED_INCLUDESTOP
...
#define EC_LINK_PARMS_SIGNATURE_ICSS_VERSION (EC_T_DWORD)0x00000002
...
typedef enum _EC_T_LINK_ICSS_BOARD
{
    ...
    EcLinkIcssBoard_am572x = 1,
    EcLinkIcssBoard_am571x = 2,
    EcLinkIcssBoard_am3359 = 3,
    EcLinkIcssBoard_am572x_emerson = 4,
...
typedef struct _EC_T_LINK_PARMS_ICSS
{
    ...
    */
    EC_T_LINK_PARMS             linkParms;
    EC_T_BYTE                   abyMac[6];              /* obsolete */
    EC_T_LINK_ICSS_BOARD        eBoardType;             /* TI AM board id */
    EC_T_BOOL                   bMaster;                /* [in] Initialize whole PRUSS subsystem */

    EC_T_BOOL                   bTts;                   /* [in] Use Time-Triggered Send */
    EC_T_DWORD                  dwTtsCycleTimeUsec;     /* [in] Cycle time between 2 pfnTtsStartCycle calls */
    EC_T_DWORD                  dwTtsSendTimeUsec;      /* [in] Time between pfnTtsStartCycle call and frame transmition */
    EC_T_LINK_ICSS_TTS_CALLBACK pfnTtsStartCycle;       /* [in] Callback function called cyclically according dwTtsCycleTimeUsec */
    EC_T_VOID*                  pvTtsStartCycleContext; /* [in] Context passed to each pfnTtsStartCycle call */
    EC_T_BOOL                   bNoMacAddr;             /* [in] true = no MAC address registers access */
...
typedef struct _EC_T_LINK_PARMS_ALTERATSE
{
    /**
    * \brief Link Layer abstraction.
    * set linkParms.dwSignature = EC_LINK_PARMS_SIGNATURE_ALTERATSE
    *
    * Must be first, see casts in usage.
    */
    EC_T_LINK_PARMS      linkParms;
    EC_T_BYTE            abyMac[6];   /* [in] MAC station address */
} EC_PACKED(8) EC_T_LINK_PARMS_ALTERATSE;
#include EC_PACKED_INCLUDESTOP
...
typedef struct _EC_T_LINK_PARMS_ANTAIOS
{
    /**
     * \brief Link Layer abstraction.
     * set linkParms.dwSignature = EC_LINK_PARMS_SIGNATURE_ANTAIOS
     *
     * Must be first, see casts in usage.
     */
    EC_T_LINK_PARMS linkParms;
} EC_PACKED(8) EC_T_LINK_PARMS_ANTAIOS;
#include EC_PACKED_INCLUDESTOP
...
#define EC_LINK_PARMS_SIGNATURE_SHETH_VERSION (EC_T_DWORD)0x00000002
...
typedef enum
{
    ...
    eSHEth_SH7724      = 2,
    eSHEth_SH7757      = 3,
    eSHEth_SH7757_GIGA = 4,
    eSHEth_SH7734      = 5,
    eSHEth_SH7763      = 6,
    eSHEth_R8A7740     = 7,  /* R Mobile */
    eSHEth_R7S72100    = 8,
    eSHEth_SH7619      = 9,
    eSHEth_SH771X      = 10, /* old stuff */
    eSHEth_R8A77400    = 11,
    eSHEth_R8A77435    = 12,
    eSHEth_R8A77430    = 13, /* RZ/G1E */
    eSHEth_R8A77450    = 14, /* RZ/G1E */
...
#define EC_LINK_PARMS_SIGNATURE_UDP_PATTERN (EC_T_DWORD)0x0000CB40
...
#define MAX_LEN_UDP_ADAPTER_NAME 64
...
typedef struct _EC_T_LINK_PARMS_UDP
{
    /**
    * \brief Link Layer abstraction.
    * set linkParms.dwSignature = EC_LINK_PARMS_SIGNATURE_UDP
    *
    * Must be first, see casts in usage.
    */
    EC_T_LINK_PARMS linkParms;

    EC_T_CHAR       szAdapterName[MAX_LEN_UDP_ADAPTER_NAME];

    EC_T_BYTE       abyIpAddress[4];
    EC_T_WORD       wPort;

} EC_PACKED(8) EC_T_LINK_PARMS_UDP;
#include EC_PACKED_INCLUDESTOP

/*-FUNCTIONS DECLARATION-----------------------------------------------------*/
ATEMLL_API EC_T_DWORD emllRegisterAntaios
...
ATEMLL_API EC_T_DWORD emllRegisterCPSW
(EC_T_LINK_DRV_DESC*  pLinkDrvDesc        /* [in,out] link layer driver descriptor */
    , EC_T_DWORD         dwLinkDrvDescSize);   /* [in]     size in bytes of link layer driver descriptor */

ATEMLL_API EC_T_DWORD emllRegisterDW3504
(EC_T_LINK_DRV_DESC*  pLinkDrvDesc        /* [in,out] link layer driver descriptor */
    , EC_T_DWORD         dwLinkDrvDescSize);   /* [in]     size in bytes of link layer driver descriptor */

ATEMLL_API EC_T_DWORD emllRegisterETSEC
(EC_T_LINK_DRV_DESC*  pLinkDrvDesc        /* [in,out] link layer driver descriptor */
    , EC_T_DWORD         dwLinkDrvDescSize);   /* [in]     size in bytes of link layer driver descriptor */
...
ATEMLL_API EC_T_DWORD emllRegisterGEM
(EC_T_LINK_DRV_DESC*  pLinkDrvDesc        /* [in,out] link layer driver descriptor */
   ,EC_T_DWORD           dwLinkDrvDescSize);   /* [in]     size in bytes of link layer driver descriptor */
...
ATEMLL_API EC_T_DWORD emllRegisterICSS
(EC_T_LINK_DRV_DESC*  pLinkDrvDesc        /* [in,out] link layer driver descriptor */
    , EC_T_DWORD         dwLinkDrvDescSize);   /* [in]     size in bytes of link layer driver descriptor */
