 ...
 *  V1.4.03 - Add LogLevel to atemsys (insmod atemsys loglevel=6) analog to kernel loglevel
...
#define ATEMSYS_VERSION_STR "1.4.04"
#define ATEMSYS_VERSION_NUM  1,4,04
#if (defined ATEMSYS_C)
#define USE_ATEMSYS_API_VERSION EC_MAKEVERSION(1,4,04,0)
#endif
